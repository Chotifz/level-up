  ...
  return (
    <div className="flex items-center py-1 justify-between gap-4">
      <div className="w-[170px]">
        <div className="flex w-40 bg-blue-300 hover:bg-purple-400 hover:border text-center justify-center items-center h-10 rounded-md">
      ...
      <div className="md:flex-row flex flex-row-reverse items-center w-full">
        <div className="flex items-center justify-center bg-slate-50 gap-1 p-1.5 rounded-lg">
          <button className="bg-yellow-200 hover:bg-purple-400 hover:border rounded font-semibold text-xs py-1.5 px-1 md:px-3">
            Sign up
          </button>
          <button className="bg-blue-100 hover:bg-purple-400 hover:border rounded py-1.5 px-1 md:px-3 max-[480px]:hidden text-xs font-extrabold font-serif">
            FREE TRIAL
          </button>
        </div>
      </div>
